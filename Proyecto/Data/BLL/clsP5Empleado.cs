...
using System.Linq;
using System.Web;
using Proyecto.Data.DAL;
using Proyecto.Data.DAL.DsProyectoTableAdapters;

namespace Proyecto.Data.BLL
{
    public class clsP5Empleado
    {
        ...
        public DsProyecto.EmpleadosDataTable getClienteXIdEmpleado(short vIdEmpleado)
        {
            mEmpleado.FillByIdEmpleado(mds.Empleados, vIdEmpleado);
            return mds.Empleados;
        }

        public DsProyecto.EmpleadosRow getEmpleadoXNumeroID(string vNumero_Ientificacion)
        {
            mEmpleado.FillByNumero_Identificacion(mds.Empleados, vNumero_Ientificacion);
        ...
        public bool ActualizarCliente(String vNumero_Identificacion, String vApellidos, String vNombre, 
            String vFecha_Nacimiento, String vDepartamento, String vEstado_Civil, String vTipo, String vJefe_Directo, 
            String vEstado, String vCorreo, short vIdEmpleado)
        {
            try
            {
        ...
        public bool BorrarEmpleado(short vIdEmpleado)
        {
            try
            {
