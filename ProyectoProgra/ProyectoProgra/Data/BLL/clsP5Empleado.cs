...
using ProyectoProgra.Data.DAL.DsProyectoTableAdapters;

namespace ProyectoProgra.Data.BLL
{
    public class clsP5Empleado
    {
        ...
        public DsProyecto.EmpleadosRow getEmpleadoXNumeroID(int vIdEmpleado)
        {
            mEmpleado.FillByIdEmpleado(mds.Empleados, vIdEmpleado);
